...
{
    public class YoloCocoPCModel : YoloModel
    {
        public  int Width { get; set; } = 640;
        public  int Height { get; set; } = 640;
        public  int Depth { get; set; } = 3;

        public  int Dimensions { get; set; } = 9;// 85;
        ...
        {
            new YoloLabel { Id = 1, Name = "cam" },
            new YoloLabel { Id = 2, Name = "clen" },
            new YoloLabel { Id = 3, Name = "face" },
            new YoloLabel { Id = 4, Name = "mobile" }
        };

        //public  List<YoloLabel> Labels1 { get; set; } = new List<YoloLabel>()
        //{
